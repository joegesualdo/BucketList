...
- (void)setupAppearance {
  ...
  // set the title text attributes, the attributes applied to the title text
  // in
  // a navigation bar
...
- (void)
     ...
     applicationDidEnterBackground:
         (UIApplication *)application{
             ...
             // invalidate
             // timers, and store enough application state information to
             // restore your
    ...
    applicationWillEnterForeground:(UIApplication *)application{
        ...
        applicationDidBecomeActive:
            (UIApplication *)application{
                ...
                // the
                // application was inactive. If the application was previously
                // in the
